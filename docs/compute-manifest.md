...
*NOTE*: Environment variables that consist of a set of comma delimited values will be treated as an array for substitution.
*NOTE*: If multiple array substitutions are included in a string, the string will be expanded to an array that is the cross product of the arrays.
